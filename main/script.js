...
const windows = {
    ...
    spinner:'<h1 style="color: white; margin-right: 5px;text-shadow: 0 0 25px #ffffff;">Squeezing</h1><img style="width: 50px; border-radius: 100%;box-shadow: 0 0 25px #F86F03;" src="https://media.giphy.com/avatars/iqoption/cBA2NTl4H0wy.gif" alt="" >'
};
let current = "start";
...
const postPrompt = (url) => {
    ...
    }).then((res) => {return res.json()}).then(res=>{main.innerHTML=windows['result'];setValue(res);});
};
